...
export class DefaultScene {
  ...
  CreateGroundMaterial(): StandardMaterial {
    ...
    const diffuse = new Texture('./textures/ground/ground-diffuse.jpg', this.scene);
    material.diffuseTexture = diffuse
    texList.push(diffuse)

    const normal = new Texture('./textures/ground/ground-normal.jpg', this.scene);
  ...
  CreateBallMaterial(): StandardMaterial {
    ...
    const diffuse = new Texture('./textures/brick/brick-diffuse.jpg', this.scene);
    material.diffuseTexture = diffuse
    texList.push(diffuse)
