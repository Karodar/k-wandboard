...
export class DefaultPBR {
  ...
  CreateSnow(): PBRMaterial {
    ...
    pbr.albedoTexture = new Texture(
      "./textures/snow/snow-diffuse.jpg",
      this.scene
    );
    ...
    pbr.metallicTexture = new Texture(
      "./textures/snow/snow-ao-rogh-metal.jpg",
      this.scene
    );
  ...
  CreateSciFiMonitor(): PBRMaterial {
    ...
    pbr.albedoTexture = new Texture(
      "./textures/sci-fi/sci-fi-basecolor.png",
      this.scene
    );
    pbr.bumpTexture = new Texture(
      "./textures/sci-fi/sci-fi-normal.png",
      this.scene
    );
    // pbr.roughness = 1
    ...
    pbr.metallicTexture = new Texture(
      "./textures/sci-fi/sci-fi-ao-rogh-metal.png",
      this.scene
    );

    pbr.emissiveColor = new Color3(1, 1, 1);
    pbr.emissiveTexture = new Texture(
      "./textures/sci-fi/sci-fi-emissive.png",
      this.scene
    );
